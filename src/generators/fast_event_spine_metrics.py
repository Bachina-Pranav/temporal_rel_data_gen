...
RUNTIME_KEYS = [
    ...
    "customer_stub_construction_seconds",
    "customer_desired_time_sampling_seconds",
    "customer_sorting_seconds",
    "customer_slot_assignment_seconds",
    "product_stub_construction_seconds",
    "product_desired_time_sampling_seconds",
    "product_sorting_seconds",
    "product_slot_assignment_seconds",
