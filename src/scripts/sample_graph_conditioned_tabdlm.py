#!/usr/bin/env python3
"""Sample attributes from graph-conditioned Conditional TABDLM."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Sample graph-conditioned Conditional TABDLM attributes.")
    parser.add_argument(
        "--config",
