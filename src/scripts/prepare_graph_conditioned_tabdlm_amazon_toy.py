#!/usr/bin/env python3
"""Prepare Amazon-toy data for graph-conditioned Conditional TABDLM."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare graph-conditioned Conditional TABDLM inputs.")
    parser.add_argument(
        "--config",
