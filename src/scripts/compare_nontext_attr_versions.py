...
KEYS = [
    ...
    "temporal_diagnostics.monthly_avg_rating_mae",
    "temporal_diagnostics.monthly_avg_rating_rmse",
    "temporal_diagnostics.monthly_avg_rating_real_std",
    "temporal_diagnostics.monthly_avg_rating_synthetic_std",
    "temporal_diagnostics.monthly_avg_rating_variance_ratio",
    "temporal_diagnostics.monthly_verified_mae",
    "temporal_diagnostics.monthly_verified_rmse",
    "temporal_diagnostics.monthly_verified_real_std",
    "temporal_diagnostics.monthly_verified_synthetic_std",
    "temporal_diagnostics.monthly_verified_variance_ratio",
    ...
    "decomposition.average_norm_base_rating_logits",
    "decomposition.average_norm_residual_rating_logits",
    "decomposition.residual_to_base_norm_ratio",
    "decomposition.temporal_calibration_average_correction_norm",
    "decomposition.temporal_calibration_num_groups_calibrated",
    "decomposition.sampled_product_effect_variance",
    "decomposition.sampled_customer_effect_variance",
    "decomposition.diagnostic_status",
    "c2st.c2st_accuracy",
]
