#!/usr/bin/env python3
"""Prepare Amazon-toy data for the joint LSTM full-review-text generator."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare joint LSTM full-review-text inputs.")
