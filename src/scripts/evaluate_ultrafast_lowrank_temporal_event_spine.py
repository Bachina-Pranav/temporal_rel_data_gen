#!/usr/bin/env python3
"""Evaluate an ultrafast low-rank temporal event spine."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate ultrafast low-rank temporal event-spine metrics.")
