#!/usr/bin/env python3
"""Prepare Amazon-toy data for v2 full-review-text Conditional TABDLM."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare v2 full-review-text Conditional TABDLM inputs.")
