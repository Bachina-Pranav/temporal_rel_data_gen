#!/usr/bin/env python3
"""Compare fast low-rank temporal event generator outputs or metric JSONs."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compare fast low-rank temporal event generator runs.")
    ...
    parser.add_argument("--output-json", default="outputs/amazon-toy/fast_lowrank_temporal_event_comparison.json")
    parser.add_argument("--output-csv", default="outputs/amazon-toy/fast_lowrank_temporal_event_comparison.csv")
