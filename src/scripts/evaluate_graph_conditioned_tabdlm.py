#!/usr/bin/env python3
"""Evaluate graph-conditioned Conditional TABDLM samples."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate graph-conditioned Conditional TABDLM attributes.")
    parser.add_argument(
        "--config",
