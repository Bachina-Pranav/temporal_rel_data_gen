#!/usr/bin/env python3
"""Run v5.3 length-preserving LSTM privacy ablations without retraining."""
...
DEFAULT_VARIANTS = [
    ...
    "v5_length_preserving_exact_block",
    "v51_length_preserving_summary_only_block",
    "v51_no_block_no_ngram_reference",
    "v5_no_block_no_ngram_reference",
]
...
class VariantSpec:
    ...
    config_path: str
    checkpoint_path: str
    length_preserving_exact_blocking: bool
    exact_train_overlap_blocking: bool
    summary_exact_blocking: bool
    review_text_exact_blocking: bool
    no_repeat_ngram: bool
    review_text_no_repeat_ngram: bool
...
VARIANTS: dict[str, VariantSpec] = {
    "v51_length_preserving_exact_block": VariantSpec(
        name="v51_length_preserving_exact_block",
        ...
        summary_exact_blocking=True,
        review_text_exact_blocking=True,
        no_repeat_ngram=False,
        review_text_no_repeat_ngram=False,
        summary_temperature=1.05,
        review_text_temperature=0.95,
        summary_top_p=0.97,
        review_text_top_p=0.95,
        purpose="Main v5.3 candidate: v5.1 with length-preserving exact blocking.",
    ),
    "v5_length_preserving_exact_block": VariantSpec(
        name="v5_length_preserving_exact_block",
        ...
        summary_top_p=0.95,
        review_text_top_p=0.95,
        purpose="v5 checkpoint with length-preserving exact blocking.",
    ),
    "v51_length_preserving_summary_only_block": VariantSpec(
        name="v51_length_preserving_summary_only_block",
        checkpoint_source="v5.1",
        config_path=V51_CONFIG,
        checkpoint_path=V51_CHECKPOINT,
        length_preserving_exact_blocking=True,
        exact_train_overlap_blocking=True,
        summary_exact_blocking=True,
        review_text_exact_blocking=False,
        no_repeat_ngram=False,
        review_text_no_repeat_ngram=False,
        summary_temperature=1.05,
        review_text_temperature=0.95,
        summary_top_p=0.97,
        review_text_top_p=0.95,
        purpose="Isolate length-preserving summary blocking.",
    ),
    "v51_no_block_no_ngram_reference": VariantSpec(
        name="v51_no_block_no_ngram_reference",
        checkpoint_source="v5.1",
        config_path=V51_CONFIG,
        checkpoint_path=V51_CHECKPOINT,
        length_preserving_exact_blocking=False,
        exact_train_overlap_blocking=False,
        summary_exact_blocking=False,
        review_text_exact_blocking=False,
        no_repeat_ngram=False,
        review_text_no_repeat_ngram=False,
        summary_temperature=1.05,
        ...
        summary_top_p=0.97,
        review_text_top_p=0.95,
        purpose="v5.1 model-only reference with no sampling privacy controls.",
    ),
    "v5_no_block_no_ngram_reference": VariantSpec(
        name="v5_no_block_no_ngram_reference",
        checkpoint_source="v5",
        config_path=V5_CONFIG,
        checkpoint_path=V5_CHECKPOINT,
        length_preserving_exact_blocking=False,
        ...
        summary_top_p=0.95,
        review_text_top_p=0.95,
        purpose="v5 model-only reference with no sampling privacy controls.",
    ),
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run v5.3 length-preserving LSTM privacy ablations.")
...
def fast_options_for_variant(spec: VariantSpec, args: argparse.Namespace, paths: VariantPaths) -> FastSamplerOptions:
    return FastSamplerOptions(
        ...
        exact_train_overlap_blocking_enabled=spec.exact_train_overlap_blocking,
        length_preserving_exact_blocking_enabled=spec.length_preserving_exact_blocking,
        field_exact_blocking_enabled={
            "summary": bool(spec.summary_exact_blocking),
            "review_text": bool(spec.review_text_exact_blocking),
        },
        field_max_resample_attempts={"summary": 5, "review_text": 3},
        summary_exact_blocking_enabled=spec.summary_exact_blocking,
        review_text_exact_blocking_enabled=spec.review_text_exact_blocking,
        no_repeat_ngram_enabled=spec.no_repeat_ngram,
        summary_no_repeat_ngram_enabled=False,
        review_text_no_repeat_ngram_enabled=spec.review_text_no_repeat_ngram,
        summary_no_repeat_ngram_size=0,
        review_text_no_repeat_ngram_size=0,
        max_summary_resample_attempts=5 if spec.exact_train_overlap_blocking else 0,
        max_review_text_resample_attempts=3 if spec.exact_train_overlap_blocking else 0,
    )
...
def sampling_config_payload(spec: VariantSpec, args: argparse.Namespace | dict[str, Any], config: ConditionalTABDLMConfig) -> dict[str, Any]:
    ...
    return {
        "ablation_name": "v5.3_lstm_length_preserving_privacy_sampler",
        "variant": spec.name,
        ...
        "sampler_defaults": {
            ...
            "detokenize_after_generation": True,
            "write_chunk_size": 10000,
            "length_preserving_exact_blocking": bool(spec.length_preserving_exact_blocking),
            "no_repeat_ngram_enabled": bool(spec.no_repeat_ngram),
            "review_text_no_repeat_ngram_enabled": bool(spec.review_text_no_repeat_ngram),
        },
...
def write_sampling_config(spec: VariantSpec, args: argparse.Namespace, config: ConditionalTABDLMConfig, path: str | Path) -> None:
    path = Path(path)
