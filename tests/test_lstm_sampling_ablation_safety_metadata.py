...
from run_lstm_sampling_privacy_ablation import VARIANTS, sampling_config_payload  # noqa: E402


def test_sampling_ablation_safety_metadata_preserves_no_leakage_contract():
    _, config, _, _, _ = make_lstm_fast_fixture()
    payload = sampling_config_payload(
        VARIANTS["v5_exact_block_only"],
        {
